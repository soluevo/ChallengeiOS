...
-    Suporte devices a partir do iPhone SE.
-    Desenvolvido em Swift 5.

### **Ganha + pontos se conter** ###
-    Desenvolver a interface em view code
-    Persistir os dados no Realm
-    Exibir os dados do Realm caso o app esteja offline
